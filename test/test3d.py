...
def test_outersphere():
    ...
    tet = tr3.TetCell(v1, v2, v3, v4, mesh=None)
    sphere = tet.outer_sphere()

    vt1 = tr3.Vertex(5, 5, 5)
    vt2 = tr3.Vertex(0.5, 0.5, 0.5)
    vt3 = tr3.Vertex(-0.5, -0.5, -0.5)
...
def test_tet_adjacent():
    ...
    v4 = tr3.Vertex(0, 1, 0)
    v5 = tr3.Vertex(0, 0, -1)
    tet1 = tr3.TetCell(v1, v2, v3, v4, mesh=None)
    tet2 = tr3.TetCell(v3, v2, v1, v5, mesh=None)
